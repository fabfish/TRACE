...
mkdir -p /data/yuzhiyuan/outputs_LLM-CL/Llama-2-7b-chat-hf/cl/$CL_METHOD
...
deepspeed --include=localhost:0,1,2,3,4,5,6,7 --master_port $port training/main.py \
    ...
    --print_loss \
    --CL_method $CL_METHOD \
    --output_dir /data/yuzhiyuan/outputs_LLM-CL/Llama-2-7b-chat-hf/cl/$CL_METHOD 2>&1 | tee /data/yuzhiyuan/outputs_LLM-CL/Llama-2-7b-chat-hf/cl/$CL_METHOD/train.log &
