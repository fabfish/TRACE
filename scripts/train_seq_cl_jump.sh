...
mkdir -p /data/yuzhiyuan/outputs_LLM-CL/Llama-3.2-1B-Instruct/cl/$CL_METHOD/grouped_3of6_perlayer_full_test
...
deepspeed --include=localhost:0,1,2,3,4,5,6,7 --master_port $port training/main.py \
    ...
    --CL_method $CL_METHOD \
    --upcycle-interval 3 \
    --output_dir /data/yuzhiyuan/outputs_LLM-CL/Llama-3.2-1B-Instruct/cl/$CL_METHOD/grouped_3of6_perlayer_full_test 2>&1 | tee /data/yuzhiyuan/outputs_LLM-CL/Llama-3.2-1B-Instruct/cl/$CL_METHOD/grouped_3of6_perlayer_full_test/train.log &
